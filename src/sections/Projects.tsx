      ...
      <div className="grid grid-cols-3 gap-12">
        <div className="w-80 h-96 flex flex-col justify-evenly items-center bg-gradient-to-t from-gray-900 rounded-lg shadow-shape">
          ...
          <div className="text-center ">
            ...
            <button onClick={openProjectModal} className="bg-blue-800 text-gray-300 mt-4 font-semibold px-4 py-4 rounded-lg flex justify-center items-center gap-8 shadow-shape" >
              ver mais <ArrowRight />
            </button>
          </div>
        </div>
